...
var instanceValidation = /** @class */ (function () {
  ...
  instanceValidation.prototype.useLabels = function (labels, labelFieldName) {
    this.labels = labels;
    this.labelFieldName =
      labelFieldName !== null && labelFieldName !== void 0
        ? labelFieldName
        : this.labelFieldName;
  };
  instanceValidation.prototype.getLabel = function (fieldPath) {
    return (0, get_wild_1.get)(
      this.labels,
      ""
        .concat(this.getGeneralFieldPath(fieldPath), ".")
        .concat(this.labelFieldName)
    );
  };
  ...
  instanceValidation.prototype.getFields = function () {
    var _a, _b;
    return ((_a = this.bind) === null || _a === void 0 ? void 0 : _a.state)
      ? (_b = this.bind) === null || _b === void 0
        ? void 0
        : _b.state[this.fieldsName]
      : {};
  };
  ...
  instanceValidation.prototype.getRule = function (rule) {
    var onlyRule =
      rule === null || rule === void 0 ? void 0 : rule.split(":")[0];
    return onlyRule;
  };
  instanceValidation.prototype.getRuleParam = function (rule) {
    var onlyParam =
      rule === null || rule === void 0 ? void 0 : rule.split(":")[1];
    return onlyParam === null || onlyParam === void 0
      ? void 0
      : onlyParam.split(",");
  };
  instanceValidation.prototype.resolveValue = function (
    fieldPath,
    value,
    rule
  ) {
  ...
  instanceValidation.prototype.resolveError = function (
    field,
    rule,
    validationResult,
    fieldValue
  ...
  instanceValidation.prototype.splitFieldPath = function (fieldPath) {
    return fieldPath.split(".*").map(function (value) {
      return value.replace(/^\.+|\.+$/g, "");
    });
  };
  instanceValidation.prototype.validateNestedWithIndex = function (
    fieldValue,
    keys,
    currentPaths,
    callback
    ...
    if (callback === void 0) {
      callback = function (fieldPath, value) {};
    }
    var key = keys[0];
    keys = keys.slice(1);
    if (Array.isArray(fieldValue) && fieldValue.length > 0) {
      fieldValue.forEach(function (fieldElement, fieldKey) {
        var currentPath = key
          ? "".concat(fieldKey, ".").concat(key)
          : fieldKey.toString();
        _this.validateNestedWithIndex(
          (0, get_wild_1.get)(fieldValue, currentPath),
          keys,
          __spreadArray(
            __spreadArray([], currentPaths, true),
            [currentPath],
            false
          ),
          callback
      ...
      this.validateNestedWithIndex(
        (0, get_wild_1.get)(fieldValue, key),
        keys,
        currentPaths,
        callback
      );
  ...
  instanceValidation.prototype.validateProcess = function (
    fieldPath,
    fieldValue,
    rule,
    selectedRule
    ...
    fieldValue = this.resolveValue(
      fieldLabel !== null && fieldLabel !== void 0 ? fieldLabel : fieldPath,
      fieldValue,
      rule
    );
  ...
  instanceValidation.prototype.eventHandler = function (
    e,
    fieldPath,
    callback
  ) {
    ...
    var field =
      fieldPath !== null && fieldPath !== void 0
        ? fieldPath
    ...
    ruleFields.forEach(function (ruleField) {
      var validationResult = _this.validate(
        fieldPath,
        _this.getRuleByField(ruleField)
      );
