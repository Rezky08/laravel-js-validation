...
var dateValidation = function (_a) {
    ...
    isDateValid = (0, date_1.default)({
        field: (_b = param.field) !== null && _b !== void 0 ? _b : "".concat(field, ".").concat(_1.availableRules.before_or_equal),
        value: param.value,
    });
    return isDateValid;
};
exports.default = (function (props) {
    ...
    return {
        ...
        message: isValid === false
            ? (0, messages_1.resolveMessage)(_1.availableRules.before_or_equal, {
                attribute: field,
